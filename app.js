...
window.addEventListener('DOMContentLoaded', function(){
  ...
  CU = { name: qs.get('name') || '', role: qs.get('role') || 'staff', username: qs.get('username') || '' };
